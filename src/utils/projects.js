export const projects = [
  {
    ...
    name: 'AVION | Онлайн-магазин мебели и декора',
    desc: 'Свежий проект, мой фаворит. Возможности: регистрация, авторизация, редактирование профиля, просмотр, фильтрация и сортировка товаров, добавление/удаление в корзину, оформление заказа, подписка на рассылку.',
    techs: [
      'Vue 3',
      'Vite',
      'Composition API',
    ...
    links: {
      deploy: 'https://avion-shop-seven.vercel.app/',
      rep: 'https://github.com/VikaBuyavykh/vue-furniture',
      layout:
        'https://www.figma.com/design/MMsgDyxk277EUjdWH65XQ2/Avion?node-id=119-3383&m=dev&t=EVFD8QVIip9dKf0J-1'
    }
  },
  {
    img: {
  ...
  {
    img: {
      big: 'explorer-big.jpg',
      small: 'explorer.jpg',
      alt: 'Скрин главной страницы веб-приложения Explorer'
    },
    name: 'MOVIES-EXPLORER | Приложение по поиску фильмов',
    desc: 'Моя дипломная работа в Яндекс.Практикуме. Возможности: регистрация, авторизация, редактирование профиля, поиск по названию, фильтрация по продолжительности, добавление/удаление в сохраненки.',
    techs: ['React', 'Webpack', 'React Router', 'Fetch API', 'БЭМ', 'Figma', 'PerfectPixel'],
    links: {
      deploy:
        'https://vk.com/away.php?to=https%3A%2F%2Fmovies-explorer-diploma.vercel.app%2Fmovies&cc_key=',
